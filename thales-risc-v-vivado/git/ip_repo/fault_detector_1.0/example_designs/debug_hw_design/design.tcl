...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of fault_detector_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins fault_detector_0/CPU0_AXI]
	connect_bd_net [get_bd_pins fault_detector_0/cpu0_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins fault_detector_0/cpu0_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins fault_detector_0/CPU1_AXI]
	connect_bd_net [get_bd_pins fault_detector_0/cpu1_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins fault_detector_0/cpu1_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M02_AXI] [get_bd_intf_pins fault_detector_0/CPU2_AXI]
	connect_bd_net [get_bd_pins fault_detector_0/cpu2_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins fault_detector_0/cpu2_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock, reset & status pins of fault_detector_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins fault_detector_0/OUT_AXI]
	connect_bd_net [get_bd_pins fault_detector_0/out_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins fault_detector_0/out_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins fault_detector_0/out_axi_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins fault_detector_0/out_axi_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins fault_detector_0/out_axi_init_axi_txn] [ get_bd_pins axi_gpio_out/gpio_io_o ]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of fault_detector_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {fault_detector_0/OUT_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_OUT_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000000} ] [get_bd_cells fault_detector_0]

	# Copy all address to fault_detector_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/fault_detector_v1_0_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_fault_detector_0_CPU0_AXI_* ]]
	puts $fp "set cpu0_axi_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_fault_detector_0_CPU1_AXI_* ]]
	puts $fp "set cpu1_axi_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_fault_detector_0_CPU2_AXI_* ]]
	puts $fp "set cpu2_axi_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:fault_detector:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/fault_detector_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "fault_detector_v1_0_hw_${i}"
